      ...
      <div className="min-h-screen bg-neutral-100 py-6 px-4 print:bg-white print:p-0">
        <div className="no-print max-w-[210mm] mx-auto mb-4 flex items-center justify-between bg-white px-5 py-3 rounded-2xl shadow-sm border border-neutral-200">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-medium text-neutral-500">Teklif No: <b className="text-black">TKF-{quote.quote_code}</b></span>
          </div>
          <div className="flex items-center gap-3">
            <button
              onClick={() => window.print()}
              className="inline-flex items-center gap-2 bg-brand-navy hover:bg-black text-white px-5 py-2 rounded-xl text-xs font-bold transition shadow-sm cursor-pointer"
            >
